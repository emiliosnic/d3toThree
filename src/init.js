...
_this.init = function(){
	...
	_this.scale.linear = function() { 
		// console.log("---------------------------- LINEAR ----------------------------");
		// console.log(arguments); 
		return _d3.scale.linear();
	}
	_this.scale.linear.range = function(start, stop, step){ 
		// console.log("---------------------------- RANGE ----------------------------");
		// console.log(arguments); 
		return _d3.range(start, stop, step);
	}
...
/*
	_this.selection.enter = function() {
		console.log("---------------------------- ENTER ----------------------------");
		console.log(arguments);
		return _d3.selection.enter(selection);
	}
	_this.selectAll = function(nodes) { 
		console.log("---------------------------- SELECT ALL ----------------------------");
		console.log(arguments);
		return _d3.selectAll(nodes); 
	}
*/
